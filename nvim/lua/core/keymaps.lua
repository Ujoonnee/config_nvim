...
-- Neo-tree
keymap.set("n", "<A-1>", ":Neotree toggle left<CR>") -- toggle focus to file explorer

-- commentary
keymap.set("n", "<leader>gc", ":Commentary<CR>")

-- Nvim-tree
--keymap.set("n", "<A-1>", ":NvimTreeToggle<CR>") -- toggle file explorer
